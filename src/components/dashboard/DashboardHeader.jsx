...
const DashboardHeader = ({ toggleSidebar, isSidebarOpen }) => {
  ...
  return (
    <motion.header
      ...
      className="flex justify-between items-center mb-4 z-20 bg-background/90 dark:bg-gray-800/40 backdrop-blur-2xl dark:border-b dark:border-gray-800 border-gray-700/50 rounded-xl px-4 lg:px-8 py-4 sticky top-4 shadow-sm"
    >
