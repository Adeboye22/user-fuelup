              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right text-gray-500 dark:text-gray-400 font-medium text-sm">
                      Total
                    </TableHead>
                  </TableRow>
                </TableHeader>
...
const OrderRow = ({ order, formatDate }) => {
  ...
  return (
    <TableRow className="border-t border-gray-200 dark:border-gray-700/30">
      <TableCell className="text-sm text-gray-800 dark:text-white">{order._id.slice(-6).toUpperCase()}</TableCell>
      <TableCell className="text-sm text-gray-600 dark:text-gray-300">
        <div className="flex items-center">
          <Calendar className="mr-2 text-gray-400 dark:text-gray-500" size={12} />
          {formatDate(order.createdAt)}
        </div>
      </TableCell>
      <TableCell className="text-sm text-gray-800 dark:text-white">{getItemSummary()}</TableCell>
