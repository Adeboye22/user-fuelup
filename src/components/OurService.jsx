      ...
      >
        <div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4">
            Our Premium <span className="text-yellow-500">Features</span>
          </h2>
          <div className="h-1 w-16 bg-emerald-500 mx-auto mb-8 rounded-full"></div>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">
            Experience unparalleled fuel delivery services tailored to meet your specific needs with efficiency and
            reliability.
          </p>
        </div>
      </motion.div>
        ...
        {services.map((service, index) => (
          ...
          >
            <div className="bg-gray-100/80 dark:bg-gray-800 p-8 rounded-3xl shadow hover:shadow-xl transition-all duration-500 h-full transform group-hover:-translate-y-2 cursor-pointer backdrop-blur-sm">
              ...
              <h3 className="font-bold text-xl text-gray-900 dark:text-gray-100 mb-3 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">
                {service.title}
              </h3>
              ...
              <div className="mt-6 pt-4 transition-opacity duration-300 border-t border-emerald-200 dark:border-emerald-800">
                <span className="text-emerald-600 dark:text-emerald-400 font-medium flex items-center">
                  ...
                  <svg
                    ...
                    className="h-4 w-4 ml-1 transform group-hover:translate-x-2 transition-transform duration-300"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
