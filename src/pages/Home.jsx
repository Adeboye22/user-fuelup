  ...
  return (
    <div className="text-gray-100 font-sans">
      ...
      <motion.section
        ...
        transition={{ duration: 0.6 }}
        variants={fadeInUp}
        className="py-24 bg-gray-800 bg-opacity-50"
      >
        <div className="container mx-auto px-4">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center mx-auto max-w-md">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-full px-8 py-4 bg-transparent text-white border-2 border-white font-bold rounded-full hover:bg-white/10 transition-colors duration-300"
            >
              Learn More
            </motion.a>
          </div>
