...
const VerifyOtpPage = () => {
  ...
  const { verifyOtp, resendOtp, tempEmail, setTempOtp } = useAuthStore()
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Enter the verification code we sent to your email</CardDescription>
        </CardHeader>
        <CardContent>
